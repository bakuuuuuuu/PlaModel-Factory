...
import { createOrder, getUserOrders, getAllOrders, deleteUserOrder, updateUserOrder, cancelOrder } from "../controllers/orderController.js";
...
// 주문 취소
router.post('/cancel/:orderId', verifyTokenForCart, cancelOrder);
