    ...
    useEffect(() => {
        const fetchProductsAndReviews = async () => {
            try {
                ...
                const filteredProducts = productResponse.data.filter(product => product.category === "디지몬");
        ...
        <div>
            ...
            <div className="productListContainer">
                <div className="productList-content-top">
                    <div className="productList-content-img-digimon">
                    </div>
                </div>
                        ...
                        <div className="productList-content-middle-bottom">
                            <div>
                                <select className="productList-filterDropdown" onChange={handleFilter}>
                                    ...
                                    <option value="Figure-Rise-Standard-Amplified">Figure-Rise-Standard-Amplified</option>
